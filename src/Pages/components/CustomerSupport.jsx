        ...
        <div className="p-2 sm:p-4 overflow-y-auto flex-1 max-h-[60vh] 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="col-span-1">
                <label>Issue Type <span className="text-red-500">*</span></label>
                 <Select
                                  ...
                                  {["Complaint", "Query","Request"].map((item) => (
              ...
              <div className="col-span-2">
                ...
                <Select
                                  ...
                                  {["Billing", "Product","Service","Delivery","Quality"].map((item) => (
                                    <MenuItem key={item} value={item.toLowerCase().replace(" ", "")}>
                                      {item}
                                    </MenuItem>
                                  ))}
              ...
              <div className="col-span-2">
                ...
                <Select
                                  ...
                                  {["Normal", "Urgent","Escalated"].map((item) => (
                                    <MenuItem key={item} value={item.toLowerCase().replace(" ", "")}>
                                      {item}
                                    </MenuItem>
                                  ))}
            ...
            <label className="sm:whitespace-nowrap">
                  Previous Interactions Reference (attachment) (You can select multiple files)
