...
const TechnicianSupport = ({ onClose, onSuccess }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="col-span-1">
                ...
                >
                  {["Washer", "Dryer", "Ironing table", "Tag Printer", "Bill printer"].map((item) => (
              ...
              <div className="col-span-2 mt-5">
                ...
                <Select
                  ...
                  {["Installation", "Repair", "Breakdown", "Preventive Maintenance"].map((item) => (
                    <MenuItem key={item} value={item.toLowerCase().replace(" ", "")}>
                      {item}
                    </MenuItem>
                  ))}
            ...
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="col-span-1">
                <label>Error Code <span className="text-red-500">*</span></label>
                <input className="w-full border rounded px-2 py-1 mt-1 text-[13px]" />
              </div>
              <div className="col-span-2">
                <label>Model/Serial Number <span className="text-red-500">*</span></label>
                <input className="w-full border rounded px-2 py-1 mt-1 text-[13px]" />
              </div>
            </div>
            ...
            <label className="sm:whitespace-nowrap">
               Error attachment (Photo) (You can select multiple files) <span className="text-red-500">*</span>
           </label>
